        ...
        <div className="w-80 shrink-0 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-2 py-1.5 text-xs text-gray-900 dark:text-gray-100 focus:border-amber-500 focus:outline-none"
            >
          ...
          <Card className="p-3 shrink-0">
            ...
            <form onSubmit={handleAddEntity} className="space-y-2">
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-1.5 text-sm text-gray-900 dark:text-gray-100 focus:border-amber-500 focus:outline-none"
              >
                {ENTITY_TYPES.map((t) => (
                  <option key={t} value={t}>
                    {t}
          ...
          {dataSource === "local" && (
            <div className="flex items-center gap-2 mb-3">
              <select
                ...
                className="flex-1 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:border-amber-500 focus:outline-none"
              >
